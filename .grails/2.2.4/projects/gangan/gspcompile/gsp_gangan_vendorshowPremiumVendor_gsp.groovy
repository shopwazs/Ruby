...
class gsp_gangan_vendorshowPremiumVendor_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/vendor/showPremiumVendor.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(7)
invokeTag('render','g',23,['template':("/vendor/showPremiumVendorTemplate"),'model':([vendor: vendor, vendorVO: vendorVO, categoryList: categoryList])],-1)
printHtmlPart(8)
})
