...
class gsp_gangan_admin_useredit_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/admin/user/edit.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(21)
invokeTag('render','g',34,['template':("/admin/user/form")],-1)
printHtmlPart(22)
